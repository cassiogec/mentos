            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <div class="well page active" id="getting-started" style="display: block;">
                        <div class="col-md-4">
                            <div class="btn-group">
                               <a href="javascript:void(0)" data-toggle="dropdown" class="btn btn-primary btn-raised">Selecione uma viagem</a>
                               ...
                               <ul class="dropdown-menu">
                                 <li><a href="javascript:void(0)">Empresas</a></li>
                                  ...
                                  <li><a href="javascript:void(0)">Something else here</a></li>
                                  <li class="divider"></li>
                                  <li class="dropdown-header">Transportes públicos</li>
                        ...
                        <div style="text-align: center;" class="col-md-4">
                            <a href="javascript:void(0)" class="btn btn-raised btn-info">Ônibus 1<div class="ripple-container"></div></a>
                            <a href="javascript:void(0)" class="btn btn-raised btn-info">Ônibus 2<div class="ripple-container"></div></a>
                        </div>
                        <div class="col-md-4">
                            <div style="text-align: center;" class="col-md-4">
                                <a href="javascript:void(0)" class="btn btn-success">Compartilhar minha posição<div class="ripple-container"></div></a>   
                            </div>
                        </div>
                        ...
                        <hr>
                        <p>Os dados de localização podem atrasar, pois o ônibus pode estar em locais sem alcance de rede.</p>
                    </div>
                </div>
            </div>
        </div>
